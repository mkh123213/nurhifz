...
Future<void> setupServiceLocator() async {
  ...
  getIt.registerLazySingleton(() => StudentsRemoteDataSource(firestore));
  getIt.registerLazySingleton(() => SessionsRemoteDataSource(firestore));
  getIt.registerLazySingleton(() => ProgressRemoteDataSource(firestore));
  getIt.registerLazySingleton(() => AttendanceRemoteDataSource(firestore));
